      ...
      <main className="flex-1">
        <article className="grid md:min-h-[404px] md:grid-cols-[1.15fr_1fr]">
          <div className="px-[18px] py-10 md:px-11 md:py-12">
            ...
            <p className="mt-[18px] max-w-[50ch] text-[18px] leading-[1.6] text-tm">
              Schülerzeitung des Uhland-Gymnasiums.
            </p>
          </div>
          {/* 4a puts the cover above the headline; 3a puts it beside it. */}
          <div className="order-first px-[18px] pb-[26px] md:order-none md:px-0 md:pb-0">
            <ArticleCover
              variant="hero"
