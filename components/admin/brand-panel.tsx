...
/**
 * The left half of screen 7a and the band above the form on 375 px. The grid is
 * drawn in the cover ink at 14%, as the rest of the project draws it — white at
 * 14% was right only while every cover sat on the one violet.
 */
